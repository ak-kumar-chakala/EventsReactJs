...
class Events extends Component {
  ...
  onClickImage = id => {
    const filteredEvent = eventsList.filter(eachItem => eachItem.id === id)

    const registrationText = filteredEvent[0].registrationStatus

    this.setState({
      registrationStatus: registrationText,
    })
  }
